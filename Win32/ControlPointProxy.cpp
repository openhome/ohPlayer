...
ControlPointProxy::ControlPointProxy(HWND aHwnd,
                                     CpStack& aCpStack,
                                     DvDevice& aDevice,
    ...
    iActiveSource(UNKNOWN)
{
    ...
    iCpPlaylist = new CPPlaylist(*iCpPlayer, aHwnd);
#ifdef ENABLE_RADIO
    iCpRadio    = new CPRadio(*iCpPlayer, aHwnd);
#endif // ENABLE_RADIO
    iCpReceiver = new CPReceiver(*iCpPlayer, aHwnd);
    iCpUpnpAv   = new CPUpnpAv(*iCpUpnpAvPlayer, aPipeline, aHwnd);
...
ControlPointProxy::CPRadio::CPRadio(Net::CpDeviceDv &aCpPlayer, HWND aHwnd) :
    iIsActive(false),
    iHwnd(aHwnd)
{
    iCpPlayer = &aCpPlayer;
